...
clock.in.out.detail <- ggplot(data.long, aes(x = date, y = time, colour = notes, fill = notes, shape = event.type)) +
  geom_jitter(size = 4, width = 0.1, height = 0.1, alpha = 0.7) +
  scale_color_manual(values = c("Post_Work_Commitment" = "darkgreen",
                   "Pre_Work_Commitment" = "green", "16_00_lecture" = "blue", "14_00_lecture" = "red", "11_00_lecture" = "black",
                   "Study_leave" = "yellow", "Conference" = "purple","Standard" = "orange")) + 
  scale_fill_manual(values = c("Post_Work_Commitment" = "darkgreen",
                   "Pre_Work_Commitment" = "green", "16_00_lecture" = "blue", "14_00_lecture" = "red", "11_00_lecture" = "black",
                   "Study_leave" = "yellow", "Conference" = "purple","Standard" = "orange")) +
